...
<div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action= "{{ url('/store') }}" method="post" class="forms-sample">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="duration" class="form-control" id="duration" min="1" max="2500">
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary me-2" value="Save">Create</button>
