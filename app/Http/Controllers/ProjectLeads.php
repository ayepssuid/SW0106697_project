...
class ProjectLeads extends Controller
{
    function index()
    {
        return view("home");
    ...
    {
      $projects = projects::all() ;
      return view('projectleader.leaderpage',['projects'=>$projects,'layout'=>'create']);
    }
    ...
    public function show($id)    
    {
      ...
      $projects = projects::all() ;
      return view('projectleader.leaderpage',['projects'=>$projects,'project'=>$project,'layout'=>'show']);
    }
